...
public class Account {
	...
	public void addAccount() {
		try {
			...
			pStmt.setString(4, "MD5("+this.getPassword()+")");
	...
	public static void update(Account account) {
		try {
			String sqlStr = "update tbl_account set user_id = ?, username = ?," +
					"password = ?, account_creation_date = ?, modified_by = ?," +
					"modification_date = ? where id = ?";
			PreparedStatement pStmt = DBConnection.getPreparedStatement(sqlStr);
			pStmt.setInt(1, account.getUserId());
			pStmt.setString(2, account.getUsername());
			pStmt.setString(3, "MD5('"+account.getPassword()+")");
	...
	public static List<Account> getAllAccounts() {
		...
		try {
			...
			while (rSet.next()) {
				account = new Account(rSet.getInt("id"),	rSet.getInt("user_id"), rSet.getString("username"),
	...
	public static Account getAccount(String username, String password) {
		...
		try {
			...
			ResultSet rSet = DBConnection.readFromDatabase(pStmt);
			while (rSet.next()) {
				account = new Account(rSet.getInt("id"),	rSet.getInt("user_id"), rSet.getString("username"),
						rSet.getString("password"),rSet.getDate("account_creation_date"),
						rSet.getInt("modified_by"),rSet.getDate("modification_date"));
