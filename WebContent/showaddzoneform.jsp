    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
                <h2>Admin Tool/አድሚኒስትሬተር መገልገያዎች &gt Zone/ዞን | [<a href="showaddzoneform.jsp">Add/ጨምር</a>] . [<a href="showlistofzones.jsp">View/ዘርዝር</a>] . [<a href="showlistofzonesforedit.jsp">Edit/አስተካክል</a>] . [<a href="showlistofzonesfordelete.jsp">Delete/አስወግድ]</a></h2>
                	
	                <div class="block" style="height:450px;background:#fff">
	            	      <form method="post" action="savezone.jsp" onsubmit="return Validate(this);">
                		<table class="form" border="1" width="100%">
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label><font color="red">*</font>Zone Name/የዞን ሥም ፡ </label></td>
                        		<td>
                        			<input type="text" name="txtzonename" id="txtzonename"/>
                        		</td>
                        	</tr>                       	
	                        <tr>
	                        	<td></td>
