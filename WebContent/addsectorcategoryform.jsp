...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="css/reset.css" media="screen" />
    ...
    <script type="text/javascript" src="validation/newFormValidation.js"></script>
    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
                <h2>Admin Tools/አድሚኒስትሬተር መገልገያዎች &gt Sector Category/የዘርፍ ምድቦች | [<a href="addsectorcategoryform.jsp">Add/ጨምር</a>] . [<a href="showlistofsectorcategories.jsp">View/ዘርዝር</a>] . [<a href="showlistofsectorcategoryforedit.jsp">Edti/አስተካክል</a>] . [<a href="showlistofsectorcategoryfordelete.jsp">Delete/አስወግድ]</a></h2>
                	
	                <div class="block" style="height:420px;background:#eee">
	            	        <form method="post" action="savesectorcategory.jsp">
                		<table class="form" border="1" width="100%">
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label> <font color="red">*</font>Sector Category Name/የዘርፍ ምድብ ሥም፡ </label></td>
                        		<td>
                        			<input type="text" class="medium" name="txtsectorcategoryname" id="txtsectorcategoryname" class="isValidChar(this);" />                        			                        			
                        		</td>
                        	</tr>
                        	<tr>
	                            <td style="vertical-align: top; padding-top: 9px;" align="right">
	                                <label>Sector Category Description/የዘርፍ ምድብ ገለፃ፡ </label>
	                            </td>
	                            <td>             
...
<script type="text/javascript">
     $(document).ready(function () { 
         ...
         $('#btnSave').click(function(){
        	 	var sectorCategoryName = $('#txtsectorcategoryname').val();
        	 	if(sectorCategoryName === ""){
        	 		alert("Enter sector category name\nየሴክተር ምድብ ሥም ያሥገቡ!");
        	 		return false;
        	 	}else{
        	 		return true;
        	 	}
