		            	     	...
		            	     	<thead>
		            	     		...
		            	     		while(sectorOrganizationItr.hasNext()){
		            	     			...
		            	     			<tr>		            	     			
		            	     				...
		            	     				<td>
		            	     					<a href="deletethisgovernmentsectororganization.jsp?sectorOrganizationId=<%=sectorOrganization.getId() %>" onclick="return window.confirm('Are you sure you want to delete this government sector organization?');"><img src="design/delete.png" border="0"/></a>
		            	     				</td>
		            	     			</tr>
		            	     			<%
		            	     		}//end while loop
