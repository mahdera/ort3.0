		            	     	...
		            	     	<thead>
		            	     		...
		            	     		while(publicRelationOfficerItr.hasNext()){
		            	     			...
		            	     			<tr>		            	     			
		            	     				...
		            	     				<td>
		            	     					<a href="showeditfieldsofpublicrelationofficer.jsp?id=<%=publicRelationOfficer.getId() %>"><img src="img/edit-icon.gif" border="0"/></a>
		            	     				</td>		            	     				
		            	     			</tr>
		            	     			<%
		            	     		}//end while loop
