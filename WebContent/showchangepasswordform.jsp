    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
                <h2>System admin username and password modification form/የሲስተም ተጠቃሚዎች ሥም እና የይለፍ ቃል ማስተካከያ ቅፅ</h2>
                ...
                <div class="block" style="height:450px;background:#fff">
                	...
                	<form method="post" action="changepassword.jsp">
                		<table border="0" width="100%" class="form">
                			...
                			<tr>
                				<td align="right" width="50%"><label>Enter current username/የአሁኑን የተጠቃሚ ሥም እዚህ ያስገቡ፡</label></td>
                				<td>
                					<input type="text" name="txtcurrentusername" id="txtcurrentusername" class="medium"/>
                				</td>
                			</tr>
                			<tr>
                				<td align="right"><label>Enter current password/የአሁኑን የይለፍ ቃል እዚህ ያስገቡ፡</label></td>
                				<td>
                					<input type="password" name="txtcurrentpassword" id="txtcurrentpassword" class="medium"/>
                				</td>
                			</tr>
                			<tr>
                				<td align="right"><label>Enter new password/አዲሱን የይለፍ ቃል እዚህ ያስገቡ፡<label></td>
                				<td>
                					<input type="password" name="txtnewpassword" id="txtnewpassword" class="medium"/>
                				</td>
                			</tr>
                			<tr>
                				<td align="right"><label>Enter new password again/አዲሱን የይለፍ ቃል በድጋሚ እዚህ ያስገቡ፡<label></td>
                				<td>
                					<input type="password" name="txtconfirmpassword" id="txtconfirmpassword" class="medium"/>
                				</td>
                			</tr>
                			<tr>
                				<td></td>
                				<td>
                					<input type="submit" value="Update/አድስ" class="btn btn-blue"/>
