...
if(session.getAttribute("account") == null){
	...
	Woreda woreda = new Woreda(zoneId,woredaName,modifiedBy,modificationDate);
	woreda.save();
%>
<jsp:forward page="showaddworedaform.jsp">
    <jsp:param name="saveStatus" value="<div class='message success'><h5>Success!</h5><p>Woreda saved successfully!</p></div>"/>
</jsp:forward>
