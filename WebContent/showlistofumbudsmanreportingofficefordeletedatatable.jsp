		            	     	...
		            	     	<thead>
		            	     		...
		            	     		while(umbudsmanReportingOfficeItr.hasNext()){
		            	     			...
		            	     			<tr>		            	     			
		            	     				...
		            	     				<td>
		            	     					<a href="deletethisumbudsmanreportingoffice.jsp?id=<%=reportingOffice.getId() %>" onclick="return confirm('Are you sure you want to delete this record/ይህንን መረጃ ለማጥፋት ወስነዋል። እርግጠኛ ነዎት?');">Delete/አስወግድ</a>
		            	     				</td>		            	     						            	     				
		            	     			</tr>
		            	     			<%
		            	     		}//end while loop
