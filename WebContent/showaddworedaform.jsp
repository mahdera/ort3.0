...
<body>
    ...
    <div class="container_12">
        ...
        <%@include file="sidebarmenu_woreda.jsp" %>
        <div class="grid_10">
            <div class="box round first">
                <h2>Admin Tool/አድሚኒስትሬተር መገልገያዎች &gt Woreda/ወረዳ | [<a href="showaddworedaform.jsp">Add/ጨምር</a>] . [<a href="showlistofworedas.jsp">View/ዘርዝር</a>] . [<a href="showlistofworedasforedit.jsp">Edit/አስተካክል</a>] . [<a href="showlistofworedasfordelete.jsp">Delete/አስወግድ]</a></h2>
                	
	                <div class="block" style="height:450px;background:#fff">
	            	      <form method="post" action="saveworeda.jsp">
                		<table class="form" border="1" width="100%">
                			...
                			<tr>
                        		<td align="right" width="30%"><label><font color="red">*</font>Select Region/የክልል ምረጥ ፡ </label></td>
                        		<td>
                        			<select name="slctregion" id="slctregion" style="width:50%" onchange="showListOfZonesInThisRegion(this.value);">
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label><font color="red">*</font>Select Zone/ዞን ምረጥ ፡ </label></td>
                        		<td>
                        			<div id="zoneDiv"></div>                      			
                        		</td>
                        	</tr> 
                        	<tr>
                        		<td align="right" width="30%"><label><font color="red">*</font>Woreda Name/የወረዳ ሥም ፡ </label></td>
                        		<td>
                        			<input type="text" name="txtworedaname" id="txtworedaname"/>
                        		</td>
                        	</tr>                       	
	                        <tr>
	                        	<td></td>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#txtworedaname').keypress(function(e){
		...
		$('#btnSave').click(function(){
			...
			var zoneName = $('#slctzone').val();
			var woredaName = $('#txtworedaname').val();
