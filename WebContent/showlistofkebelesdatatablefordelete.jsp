...
<table border="0" id="datatables" class="display">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="deletethiskebele.jsp?kebeleId=<%=kebele.getId() %>" onclick="return window.confirm('Are you sure you want to delete this kebele?');"><img src="design/delete.png" border="0"/></a>
			</td>
		</tr>
		<%
			}//end while loop
