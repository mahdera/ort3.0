    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
                <h2>Admin Tool/አድሚኒስትሬተር መገልገያዎች &gt Ombudsman Reporting Office/እንባ ጠባቂ ሪፖርት አቅራቢ ክፍል | [<a href="showaddumbudsmanreportingoffice.jsp">Add/ጨምር</a>] . [<a href="showlistofumbudsmanreportingoffices.jsp">View/ዘርዝር</a>] . [<a href="showlistofumbudsmanreportingofficeforedit.jsp">Edit/አስተካክል</a>] . [<a href="showlistofumbudsmanreportingofficefordelete.jsp">Delete/አስወግድ]</a></h2>
