    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
                <h2>Admin Tool/አድሚኒስትሬተር መገልገያዎች &gt Signature/ፊርማ | [<a href="showaddsignatureform.jsp">Add/ጨምር</a>] . [<a href="showlistofsignatures.jsp">View/ዘርዝር</a>] . [<a href="showlistofsignaturesfordelete.jsp">Delete/አስወግድ</a>]</h2>
                	
	             <div class="block">
	                	<%@include file="showlistofsignaturesdatatablefordelete.jsp" %>	            	                        
	            	</div>
        </div>
        <div class="clear">
        </div>
