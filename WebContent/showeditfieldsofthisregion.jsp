    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
                <h2>አድሚኒስትሬተር መገልገያዎች &gt ክልል | [<a href="showaddregionform.jsp">ጨምር</a>] . [<a href="showlistofregions.jsp">ዘርዝር</a>] . [<a href="showlistofregionforedit.jsp">አስተካክል</a>] . [<a href="showlistofregionfordelete.jsp">አስወግድ]</a></h2>
                	
	                <div class="block" style="height:450px;background:#eee">
	            	      <form method="post" action="updateregion.jsp">
                		<table class="form" border="1" width="100%">
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label>የክልል ሥም ፡ </label></td>
                        		<td>
                        			<input type="text" class="medium" name="txtregionname" id="txtregionname" value="<%=region.getRegionName() %>"/>
