...
<body>
        ...
        <div class="grid_10">
            <div class="box round first">
                ...
                <div class="block" style="height:430px;background:#eee">
        			 ...
        			 <form method="post" action="saveinformationimplementationadmincostandcontinue.jsp">
        			 	<table border="1" width="100%" class="form">
        			 		<tr style="background:lightyellow">
        			 			<td style="font-size:14pt;float:center;font-weight:bolder">7. ሪፖርት ፎርም ታድሶ አልቋል!:</td>
        			 		</tr>
        			 		<tr>
        			 			<td>
        			 				<div class="message success">
        			 					<h5>ማሳሰቢያ</h5>
        			 					<p>ሪፖርት ፎርም ታድሶ አልቋል!</p>
        			 				</div>     			 				
        			 			</td>
        			 		</tr>
        			 	</table>
    ...
    <div id="site_info">
        <p>
            Copyright <a href="#">ORT3.0</a>. All Rights Reserved.
        </p>
    </div>
    </div>
</body>
