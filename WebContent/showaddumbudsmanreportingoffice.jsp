            ...
            <div class="box round first">
                <h2>Admin Tool/አድሚኒስትሬተር መገልገያዎች &gt Umbudsman Reporting Office/እንባ ጠባቂ ሪፖርት አቅራቢ ክፍል | [<a href="showaddumbudsmanreportingoffice.jsp">Add/ጨምር</a>] . [<a href="showlistofumbudsmanreportingoffices.jsp">View/ዘርዝር</a>] . [<a href="showlistofumbudsmanreportingofficeforedit.jsp">Edit/አስተካክል</a>] . [<a href="showlistofumbudsmanreportingofficefordelete.jsp">Delete/አስወግድ]</a></h2>
	                ...
	                <div class="block" style="height:450px;">
	            	     <form method="post" action="saveumbudsmanreportingoffice.jsp">
                		<table class="form" border="1" width="100%">
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label><font color="red">*</font>Name/የእንባ ጠባቂ ሪፖርት አቅራቢ መሥሪያ ቤት ሥም ፡ </label></td>
                        		<td>
                        			<input type="text" class="medium" name="txtreportingofficename" id="txtreportingofficename"
                        			validate="not_empty" msg="<font color='red'>Enter reporting office name</font>"/>
                        		</td>
                        	</tr>
                        	<tr>
	                            <td style="vertical-align: top; padding-top: 9px;" align="right">
	                                <label>Description/የእንባ ጠባቂ ሪፖርት አቅራቢ መሥሪያ ቤት ገለፃ ፡ </label>
	                            </td>
	                            <td>
	                        ...
	                        <tr>
                        		<td align="right" width="30%"><label><font color="red">*</font>Branch/ቅርንጫፍ ፡ </label></td>
                        		<td>
                        			<select name="slctbranch" id="slctbranch" style="width:100%" validate="not_empty"
                        			msg="<font color='red'>Select branch</font>">
...
<script type="text/javascript">
     $(document).ready(function () { 
         ...
         $('#btnSave').click(function(){
        	 	var organizationName = $('#txtreportingofficename').val();
        	 	var branchId = $('#slctbranch').val();
        	 	
        	 	if(organizationName === ""){
        	 		alert("Enter organization name\nየእንባ ጠባቂ ሪፖርት አቅራቢ መሥሪያ ቤት ሥም አሥገባ!");
        	 		return false;
        	 	}else if(branchId === ""){
        	 		alert("Select branch\nቅርንጫፍ ይምረጡ!");
        	 		return false;
