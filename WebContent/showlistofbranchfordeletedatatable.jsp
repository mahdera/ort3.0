		            	     	...
		            	     	<thead>
		            	     		...
		            	     		while(branchItr.hasNext()){
		            	     			...
		            	     			<tr>	
		            	     				...
		            	     				<td><%=fullName %></td>
		            	     				<td><%=branch.getModificationDate() %></td>
		            	     				<td>
		            	     					<a href="deletethisbranch.jsp?branchId=<%=branch.getId() %>" onclick="return window.confirm('Are you sure wante to delete this branch?');">Delete/አስወግድ</a>
		            	     				</td>		            	     						            	     				
		            	     			</tr>
		            	     			<%
		            	     		}//end while loop
