    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
                <h2>አድሚኒስትሬተር መገልገያዎች &gt ወረዳ | [<a href="showaddworedaform.jsp">ጨምር</a>] . [<a href="showlistofworedas.jsp">ዘርዝር</a>] . [<a href="showlistofworedasforedit.jsp">አስተካክል</a>] . [<a href="showlistofworedasfordelete.jsp">አስወግድ]</a></h2>
                	<%
	                ...
	                <div class="block" style="height:450px;background:#eee">
	            	      <form method="post" action="updateworeda.jsp" onsubmit="return Validate(this);">
	            	      <input type="hidden" name="hiddenid" id="hiddenid" value="<%=woredaId %>"/>
                		<table class="form" border="1" width="100%">
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label>ዞን ምረጥ ፡ </label></td>
                        		<td>
                        				...
                        				<%
                        					...
                        					if(!zoneList.isEmpty()){
                        						...
                        						while(zoneItr.hasNext()){
                        							...
                        							if(zone.getId() == woreda.getZoneId()){
                        							%>
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label>የወረዳ ሥም ፡ </label></td>
                        		<td>
                        			<input type="text" name="txtworedaname" id="txtworedaname" value="<%=woreda.getWoredaName() %>"/>
                        		</td>
                        	</tr>                       	
	                        <tr>
	                        	<td></td>
