    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
                <h2>Admin Tool/አድሚኒስትሬተር መገልገያዎች &gt Kebele/ቀበሌ | [<a href="showaddkebeleform.jsp">Add/ጨምር</a>] . [<a href="showlistofkebeles.jsp">View/ዘርዝር</a>] . [<a href="showlistofkebelesforedit.jsp">Edit/አስተካክል</a>] . [<a href="showlistofkebelesfordelete.jsp">Delete/አስወግድ]</a></h2>
                	
	                <div class="block" style="height:450px;background:#fff">
	            	      <form method="post" action="savekebele.jsp">
                		<table class="form" border="1" width="100%">
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label><font color="red">*</font>Select Woreda/ወረዳ ምረጥ ፡ </label></td>
                        		<td>
                        	...
                        	<tr>
                        		<td align="right" width="30%"><label><font color="red">*</font>Kebele Name/የቀበሌ ሥም ፡ </label></td>
                        		<td>
                        			<input type="text" name="txtkebelename" id="txtkebelename"/>
                        		</td>
                        	</tr>                       	
	                        <tr>
	                        	<td></td>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnSave').click(function(){
			var woredaId = $('#slctworeda').val();
			var kebeleName = $('#txtkebelename').val();
			
			if(woredaId === ""){
				alert("Select woreda\nወረዳ ምረጥ");
				return false;
			}else if(kebeleName === ""){
				alert("Enter kebele name\nየቀበሌ ሥም");
				return false;
			}else{
				return true;
			}
