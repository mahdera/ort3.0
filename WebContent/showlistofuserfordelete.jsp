	                ...
	                <div class="block" style="height:450px;background:#fff">
	            	    <form>
	            	    	<table border="0" width="100%" class="form">
	            	    		<tr>
	            	    			<td><label>Select System User Type/የሲስተም ተጠቃሚ ዓይነት ምረጥ፡</label></td>
	            	    			<td>
	            	    				<select name="slctsystemusertype" id="slctsystemusertype" style="width:90%">
	                        				<option value="" selected="selected">--Select/ምረጥ--</option>
	                        				<option value="Public Relation Officer">Public Relation Employee/ሕዝብ ግንኙነት ሠራተኛ</option>
	                        				<option value="System Administrator">System Admin/ሲስተም አድሚኒስትሬተር</option>
	                        				<option value="Umbudsman Reporting Officer">Umbudsman Office Reporter/የእንባ ጠባቂ ሪፖርተር</</option>
                        				</select>	            	    				
	            	    			</td>
	            	    			<td>
	            	    			...
	            	    			<td>
	            	    				<input type="button" value="Show/አሣይ" onclick="showListOfUsersOfThisUserTypeForDelete(document.getElementById('slctsystemusertype').value);" class="btn btn-blue"/>
