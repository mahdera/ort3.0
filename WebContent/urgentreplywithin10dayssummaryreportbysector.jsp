...
<div id="regionLevelReportDiv">
	...
	<%
		...
		while(sectorOrganizationItr.hasNext()){
			...
			float numberOfInformationRequesterUrgentIn10DaysPercent = ReportGenerator.getReportSumDataForTableFieldOnThisLevelSelectedValueDuringForSector("tbl_service_performed_by_the_given_time_duration", "number_of_urgent_information_request_between_10_days", reportLevel, selectedTerritoryId, dateFrom, dateTo,organization.getId());
			float averageNumberOfDaysTakenToServeRequestUrgentIn10DaysDays = ReportGenerator.getReportSumDataForTableFieldOnThisLevelSelectedValueDuringForSector("tbl_service_performed_by_the_given_time_duration", "number_of_days_required_to_serve_urgent_request_between_10_days", reportLevel, selectedTerritoryId, dateFrom, dateTo,organization.getId());
			%>
			<tr>
